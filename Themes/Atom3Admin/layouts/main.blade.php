...
<body class="hold-transition skin-{{ config('admin-lte.skin', 'blue') }} {{ config('admin-lte.layout', 'sidebar-mini') }}">
  ...
  @section('scripts')
  <script src="{{ assets('/js/manifest.js') }}" charset="utf-8"></script>
  <script src="{{ assets('/js/vendor.js') }}" charset="utf-8"></script>
  <script src="{{ assets('/js/admin-lte.js') }}" charset="utf-8"></script>
  @show
  @stack('body')
</body>
</html>
